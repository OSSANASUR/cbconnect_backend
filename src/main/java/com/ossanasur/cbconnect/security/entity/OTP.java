...
@Entity @DiscriminatorValue("OTP")
public class OTP extends InternalHistorique implements Serializable {
    @Column(name = "otp_tracking_id", unique = true) private UUID otpTrackingId;
