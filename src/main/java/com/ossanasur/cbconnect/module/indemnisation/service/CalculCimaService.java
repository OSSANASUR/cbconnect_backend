 ...
 * Implémenté par CalculCimaServiceImpl qui concentre toutes les formules légales.
 */
public interface CalculCimaService {
    /** Calcule et sauvegarde une offre d'indemnisation pour une victime blessée */
    OffreIndemnisation calculerOffreBlesse(Victime victime, String loginAuteur);
    /** Calcule et sauvegarde une offre d'indemnisation pour une victime décédée */
    OffreIndemnisation calculerOffreDeces(Victime victime, String loginAuteur);
