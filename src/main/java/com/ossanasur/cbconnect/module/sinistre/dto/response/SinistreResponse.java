...
public record SinistreResponse(
        ...
        boolean estPrefinance,
        boolean estContentieux,
        String paysGestionnaireLibelle,
        String paysEmetteurLibelle,
        String organismeMembreRaisonSociale,
        String organismeHomologueRaisonSociale,
        String assureNomComplet,
        String assureImmatriculation,
        String redacteurNomPrenom,
