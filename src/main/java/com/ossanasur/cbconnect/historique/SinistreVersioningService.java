...
public class SinistreVersioningService extends AbstractVersioningService<Sinistre, SinistreRequest> {
    ...
    protected Sinistre mapToEntity(SinistreRequest r, Sinistre ex) {
        ...
        if (r.typeSinistre() != null)
            u.setTypeSinistre(r.typeSinistre());
        if (r.typeDommage() != null)
            u.setTypeDommage(r.typeDommage());
        if (r.dateAccident() != null)
            u.setDateAccident(r.dateAccident());
