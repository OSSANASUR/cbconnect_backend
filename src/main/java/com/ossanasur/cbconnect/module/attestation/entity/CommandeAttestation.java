...
@SuperBuilder
@Entity
@DiscriminatorValue("COMMANDE_ATTESTATION")
@Table(name = "commande_attestation")
public class CommandeAttestation extends InternalHistorique {
    @Column(name = "commande_tracking_id", unique = true)
    ...
    @Builder.Default
    private StatutCommandeAttestation statut = StatutCommandeAttestation.PROFORMA_EMISE;
    @Column(nullable = false)
    private Integer quantite;
    @Column(nullable = false)
    @Builder.Default
    private BigDecimal prixUnitaireVente = new BigDecimal("1075");
    @Column(nullable = false)
    @Builder.Default
    private BigDecimal tauxContributionFonds = new BigDecimal("100");
    @Column(nullable = false)
