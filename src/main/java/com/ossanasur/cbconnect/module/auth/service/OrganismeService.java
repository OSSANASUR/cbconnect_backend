...
public interface OrganismeService {
    ...
    DataResponse<OrganismeResponse> uploadBrandingImage(UUID trackingId, BrandingImageType type, MultipartFile file,
            String loginAuteur);
    ...
    DataResponse<List<OrganismeResponse>> listerActifs(List<TypeOrganisme> types);
}
