...
@Entity @DiscriminatorValue("EXPERTISE_MATERIELLE")
public class ExpertiseMaterielle extends InternalHistorique implements Serializable {
    @Column(name="expertise_ma_tracking_id",unique=true) private UUID expertiseMaTrackingId;
    @Column(nullable=false) private LocalDate dateDemande;
    private LocalDate dateRapport; private BigDecimal montantDevis; private BigDecimal montantDitExpert;
    @Builder.Default private BigDecimal honoraires = BigDecimal.ZERO; private Integer paperlessDocumentId;
