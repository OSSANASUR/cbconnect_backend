...
@RestController @RequestMapping("/v1/victimes") @RequiredArgsConstructor
...
public class VictimeController {
    ...
    public ResponseEntity<DataResponse<VictimeResponse>> create(@Valid @RequestBody VictimeRequest r, @AuthenticationPrincipal UserDetails u) {
    ...
    public ResponseEntity<DataResponse<VictimeResponse>> update(@PathVariable UUID id, @Valid @RequestBody VictimeRequest r, @AuthenticationPrincipal UserDetails u) {
