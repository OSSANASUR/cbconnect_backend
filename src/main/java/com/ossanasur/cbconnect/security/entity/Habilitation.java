...
public class Habilitation extends InternalHistorique {
    @Column(name = "habilitation_tracking_id", unique = true)
    private UUID habilitationTrackingId;
    @Column(unique = true)
    private String codeHabilitation;
    private String libelleHabilitation;
    private String description;
    @Enumerated(EnumType.STRING)
    private ActionHabilitation action;
    @Enumerated(EnumType.STRING)
    private TypeAccesHabilitation typeAcces;
    @ManyToOne
